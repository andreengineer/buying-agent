# Perplexity Pro Deep Research Brief
## Isaura Valuation Engine: "Vale Esse Preço?" — Price-to-Value Intelligence for UHNW Purchasing

**Copie isto → cole no Perplexity Pro → selecione "Deep Research" → aguarde output.**

---

## Mission

Research and document how to build an AI system that answers "is this product worth its price?" for high-net-worth individuals (UHNW) purchasing luxury goods — specifically wine, watches, jewelry, art, and premium experiences. This is NOT price comparison (Buscapé/Zoom). It is **price-to-value curatorship**: evaluating whether a product's quality, status, craftsmanship, provenance, and market positioning justify its asking price for a discerning buyer who values time over savings.

---

## Research Questions (answer all in depth)
